...
const foodFormConfig: ListingFormConfig<InsertFoodEvent> = {
  ...
  applyRedoResponse: (res, { setForm, setInstanceNote, setInstanceTitle }) => {
    ...
    setForm(f => ({
      ...
      ...(res.dateEnd ? { dateEnd: res.dateEnd } : {}),
...
export default function AmsueBouche() {
  ...
  const [filterDuration, setFilterDuration] = useState(() => new URLSearchParams(window.location.search).get("evDuration") || "all");
  ...
  useEffect(() => {
    ...
    filterDuration !== "all" ? url.searchParams.set("evDuration", filterDuration) : url.searchParams.delete("evDuration");
  ...
  }, [filterCuisine, filterRegion, filterDay, filterDuration, sortBy, searchQuery]);
  ...
  return (
    <div className={`min-h-screen flex flex-col ${viewMode === "calendar" && isMobile ? "h-dvh" : ""}`} style={{ backgroundColor: AB_GOLD }}>

      {/* ── Navbar ── */}
      <nav ref={navRef} className="sticky top-0 z-50 shadow-md" style={{ backgroundColor: AB_ORANGE }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent><p>Browse Denver's best spots</p></TooltipContent>
                </Tooltip>
              </TooltipProvider>
        ...
        {viewMode === "list" && sortBy === "date" && stillTimeEvents.length > 0 && (
          <div className="mb-6">
            ...
            <div
              ...
              style={{ backgroundColor: AB_DAY_ALT }}
            >
      ...
      <footer className={`py-4 px-4 ${viewMode === "calendar" ? "hidden md:block" : ""}`} style={{ backgroundColor: AB_GOLD }}>
              ...
              <div className="overflow-y-auto min-h-0 flex-1">
                <div className="pl-6 pr-12 pt-9 pb-4" style={{ backgroundColor: AB_GOLD }}>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2">
                    <span className="text-sm md:text-[11px] font-bold uppercase tracking-wide px-2.5 py-1 md:px-2 md:py-0.5 rounded-full border border-black/30 text-black/70">{ev.cuisine}</span>
                  </div>
                </div>
