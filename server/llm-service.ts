...
import { artTopicTags } from '@shared/schema';
...
Return this exact JSON structure (no markdown, no code blocks):
{
  ...
  "category": "the FORMAT of the event — one of: Theater & Musicals, Comedy & Storytelling, Film & Cinema, Dance & Movement, Music & Performance, Galleries & Exhibitions, Games, Workshops & Classes, Book Clubs, Talks & Lectures, Markets & Pop-Ups, Parties & Social, Tours & Outings — choose the closest fit by HOW the event is experienced, not what it's about (subject goes in tags below instead): Theater & Musicals = plays/musicals/opera/broadway touring shows; Comedy & Storytelling = stand-up/improv/story slams/storytelling shows/comedy nights; Film & Cinema = film festivals/screenings/documentary events; Dance & Movement = ballet/modern dance/concert dance/dance nights; Music & Performance = live concerts/jazz/classical/open mic/DJ sets; Galleries & Exhibitions = gallery openings/art exhibits/museum shows/studio tours (viewing, not making); Games = dedicated game nights or clubs — board games, tabletop/RPG (D&D and similar), video/arcade games, chess, Go, backgammon, mahjong, card games, game-design playtests (NOT bar trivia or pub-quiz nights hosted as a talk/show format — those are Talks & Lectures or Comedy & Storytelling depending on tone); Workshops & Classes = hands-on classes/figure drawing/pottery/craft nights/making workshops (participatory, any subject — a birding class or a wellness class still goes here, with the subject captured in tags); Book Clubs = recurring or one-off group discussions of a specific book/reading, book-club meetups; Talks & Lectures = author events/expert lectures/seminars/academic panels/salons/symposiums/speaker series, INCLUDING science/nature talks and astronomy talks (passive-audience talks not centered on discussing a specific book); Markets & Pop-Ups = artisan markets/craft fairs/swap meets/pop-up shops; Parties & Social = dance parties/themed parties/club nights/warehouse raves/costume parties/seasonal bashes/social mixers/wellness or community mixers; Tours & Outings = guided walks/tours/rides/field trips (train rides, architecture tours, nature walks, historic-site tours) — physically going somewhere and being led through it, not sitting for a talk",
  "tags": "the SUBJECT/TOPIC of the event — array of zero or more from this exact list (empty array if none clearly fit, never invent new tags): ${artTopicTags.join(', ')}. Pick every tag that genuinely applies (usually 0-3): e.g. a talk about Saturn is Talks & Lectures with tags [\"Astronomy\", \"Science\"]; a guided bird walk is Tours & Outings with tags [\"Birding\", \"Nature & Outdoors\"]; a figure drawing class is Workshops & Classes with tags [\"Art\"]; a meditation mixer is Parties & Social with tags [\"Wellness\"]; a talk on a ballot measure or foreign policy is Talks & Lectures with tags [\"Politics\"]; a pickleball or cornhole tournament is Parties & Social with tags [\"Sport\"]; a coding meetup or AI demo night is Talks & Lectures or Workshops & Classes with tags [\"Tech\"]. Do not force a tag if nothing on the list genuinely fits.",
