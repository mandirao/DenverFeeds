...
Return this exact JSON structure (no markdown, no code blocks):
{
  ...
  "tags": "the SUBJECT/TOPIC of the event — array of zero or more from this exact list (empty array if none clearly fit, never invent new tags): ${artTopicTags.join(', ')}. Pick every tag that genuinely applies (usually 0-3): e.g. a talk about Saturn is Talks & Lectures with tags [\"Astronomy & Space\", \"Science\"]; a guided bird walk is Tours & Outings with tags [\"Birding\", \"Nature & Outdoors\"]; a figure drawing class is Workshops & Classes with tags [\"Art & Visual Culture\"]; a meditation mixer is Parties & Social with tags [\"Wellness & Mindfulness\"]. Do not force a tag if nothing on the list genuinely fits.",
