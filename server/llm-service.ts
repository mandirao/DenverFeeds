...
Return this exact JSON structure (no markdown, no code blocks):
{
  ...
  "category": "one of: Theater & Musicals, Comedy & Storytelling, Film & Cinema, Dance & Movement, Music & Performance, Galleries & Exhibitions, Games, Workshops & Classes, Science & Nature, Book Clubs, Talks & Lectures, Markets & Pop-Ups, Wellness & Community, Parties & Social — choose the closest fit: Theater & Musicals = plays/musicals/opera/broadway touring shows; Comedy & Storytelling = stand-up/improv/story slams/storytelling shows/comedy nights; Film & Cinema = film festivals/screenings/documentary events; Dance & Movement = ballet/modern dance/concert dance/dance nights; Music & Performance = live concerts/jazz/classical/open mic/DJ sets; Galleries & Exhibitions = gallery openings/art exhibits/museum shows/studio tours (viewing, not making); Games = dedicated game nights or clubs — board games, tabletop/RPG (D&D and similar), video/arcade games, chess, Go, backgammon, mahjong, card games, game-design playtests (NOT bar trivia or pub-quiz nights hosted as a talk/show format — those are Talks & Lectures or Comedy & Storytelling depending on tone); Workshops & Classes = hands-on art classes/figure drawing/pottery/craft nights/making workshops (participatory); Science & Nature = astronomy/science talks/nature/natural history (including science lectures — subject beats format); Book Clubs = recurring or one-off group discussions of a specific book/reading, book-club meetups; Talks & Lectures = author events/expert lectures/seminars/literary or academic panels/salons/symposiums/speaker series (passive-audience talks not centered on discussing a specific book); Markets & Pop-Ups = artisan markets/craft fairs/swap meets/pop-up shops; Wellness & Community = meditation/yoga/community social events/seasonal gatherings; Parties & Social = dance parties/themed parties/club nights/warehouse raves/costume parties/seasonal bashes/social mixers",
